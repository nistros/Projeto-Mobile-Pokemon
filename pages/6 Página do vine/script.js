// Lista de todos os Pokémon (até a Geração 9 - 1008 Pokémon)
// Esta lista é grande, mas é necessária para a funcionalidade de autocompletar.
// Para uma lista mais robusta e atualizada, você poderia usar uma API como a PokeAPI.
const allPokemonNames = [
  ...
  "Druddigon", "Golett", "Golithet", "Pawniard", "Bisharp", "Bouffalant", "Rufflet", "Braviary", "Vullaby", "Mandibuzz",
  ...
  "Pikipek", "Trumbeak", "Toucannon", "Gumshoos", "Grubbin", "Charjabug", "Vikavolt", "Crabrawler", "Crabominable", "Oricorio",
  "Cutiefly", "Ribombee", "Rockruff", "Lycanroc", "Wishiwashi", "Mareanie", "Toxapex", "Mudbray", "Mudsdale", "Dewpider",
  ...
  "Type: Null", "Silvally", "Minior", "Komala", "Turtonator", "Togedemaru", "Mimikyu", "Bruxish", "Drampa", "Dhelmise",
  "Jangmo-o", "Hakamo-o", "Kommo-o", "Tapu Koko", "Tapu Lele", "Tapu Bulu", "Tapu Fini", "Cosmog", "Cosmoem", "Solgaleo",
  ...
  "Rillaboom", "Scorbunny", "Raboot", "Cinderace", "Sobble", "Drizzile", "Inteleon", "Wookee", "Corvisquire", "Corviknight",
  "Blipbug", "Dottler", "Orbeetle", "Nickit", "Thievul", "Gossifleur", "Eldegoss", "Wooloo", "Dubwool", "Chewtle",
  "Drednaw", "Yamper", "Boltund", "Rolycoly", "Carkol", "Coalossal", "Applin", "Flapple", "Appletun", "Silicobra",
  "Sandaconda", "Cramorant", "Arrokuda", "Barraskewda", "Toxtricity", "Sizzlipede", "Centiskorch", "Clobbopus", "Grapploct", "Sinistea",
  "Polteageist", "Hatenna", "Hattrem", "Hatterene", "Impidimp", "Morgrem", "Grimmsnarl", "Obstagoon", "Perrserker", "Cursola",
  "Sirfetch'd", "Mr. Rime", "Runerigus", "Milcery", "Alcremie", "Falinks", "Pincurchin", "Snom", "Frosmoth", "Stonjourner",
  "Eiscue", "Indeedee", "Morpeko", "Cufant", "Copperajah", "Dracozolt", "Arctozolt", "Dracovish", "Arctovish", "Duraludon",
  ...
  "Lechonk", "Oinkologne", "Tarountula", "Spidops", "Nymble", "Crickton", "Pawmi", "Pawmo", "Pawmot", "Tandemaus",
  "Maushold", "Fidough", "Dachsbun", "Smoliv", "Dolliv", "Arboliva", "Squawkabilly", "Nacli", "Naclstack", "Garganacl",
  "Charcadet", "Armarouge", "Ceruledge", "Tadbulb", "Bellibolt", "Wattrel", "Kilowattrel", "Mothim", "Bombirdier", "Finizen",
  "Palafin", "Veluza", "Dondozo", "Tatsugiri", "Cetoddle", "Cetitan", "Frigibax", "Arctibax", "Baxcalibur", "Tinkatink",
  "Tinkatuff", "Tinkaton", "Wiglett", "Wugtrio", "Donphan", "Glimmet", "Glimmora", "Toedscool", "Toedscruel", "Capsakid",
  "Scovillain", "Rellor", "Rabsca", "Flittle", "Espathra", "Tinkatink", "Tinkatuff", "Tinkaton", "Wiglett", "Wugtrio",
  "Bombirdier", "Finizen", "Palafin", "Veluza", "Dondozo", "Tatsugiri", "Cetoddle", "Cetitan", "Frigibax", "Arctibax",
  "Baxcalibur", "Tinkatink", "Tinkatuff", "Tinkaton", "Wiglett", "Wugtrio", "Glimmet", "Glimmora", "Toedscool", "Toedscruel",
  "Capsakid", "Scovillain", "Rellor", "Rabsca", "Flittle", "Espathra", "Klawf", "Capsakid", "Scovillain", "Rellor",
  "Rabsca", "Flittle", "Espathra", "Tinkatink", "Tinkatuff", "Tinkaton", "Wiglett", "Wugtrio", "Bombirdier", "Finizen",
  "Palafin", "Veluza", "Dondozo", "Tatsugiri", "Cetoddle", "Cetitan", "Frigibax", "Arctibax", "Baxcalibur", "Tinkatink",
  "Tinkatuff", "Tinkaton", "Wiglett", "Wugtrio", "Glimmet", "Glimmora", "Toedscool", "Toedscruel", "Capsakid", "Scovillain",
  "Rellor", "Rabsca", "Flittle", "Espathra", "Klawf", "Capsakid", "Scovillain", "Rellor", "Rabsca", "Flittle",
  "Espathra", "Tinkatink", "Tinkatuff", "Tinkaton", "Wiglett", "Wugtrio", "Bombirdier", "Finizen", "Palafin", "Veluza",
  "Dondozo", "Tatsugiri", "Cetoddle", "Cetitan", "Frigibax", "Arctibax", "Baxcalibur", "Tinkatink", "Tinkatuff", "Tinkaton",
  "Wiglett", "Wugtrio", "Glimmet", "Glimmora", "Toedscool", "Toedscruel", "Capsakid", "Scovillain", "Rellor", "Rabsca",
  "Flittle", "Espathra", "Klawf", "Tinkatink", "Tinkatuff", "Tinkaton", "Wiglett", "Wugtrio", "Bombirdier", "Finizen",
  "Palafin", "Veluza", "Dondozo", "Tatsugiri", "Cetoddle", "Cetitan", "Frigibax", "Arctibax", "Baxcalibur", "Tinkatink",
  "Tinkatuff", "Tinkaton", "Wiglett", "Wugtrio", "Glimmet", "Glimmora", "Toedscool", "Toedscruel", "Capsakid", "Scovillain",
  "Rellor", "Rabsca", "Flittle", "Espathra", "Klawf", "Gimmighoul", "Gholdengo", "Wo-Chien", "Chien-Pao", "Ting-Lu",
  "Chi-Yu", "Roaring Moon", "Iron Valiant", "Koraidon", "Miraidon", "Walking Wake", "Iron Leaves", "Dipplin", "Poltchageist",
  "Sinistcha", "Okidogi", "Munkidori", "Fezandipiti", "Ogerpon", "Archaludon", "Hydrapple", "Gouging Fire", "Raging Bolt",
...
pokemonSearchInput.addEventListener('input', () => {
  ...
  selectedSuggestionIndex = -1; // Reseta a seleção do teclado

  if (searchTerm.length === 0) {
      pokemonSuggestions.classList.remove('active');
      return;
  }
  ...
  if (filteredPokemon.length > 0) {
      filteredPokemon.forEach((pokemon, index) => {
          ...
          suggestionItem.addEventListener('click', () => {
              pokemonSearchInput.value = pokemon;
              pokemonSuggestions.classList.remove('active');
          });
          pokemonSuggestions.appendChild(suggestionItem);
      });
      pokemonSuggestions.classList.add('active');
  } else {
      pokemonSuggestions.classList.remove('active');
  }
});

// Lidar com cliques fora da barra de pesquisa para fechar sugestões
document.addEventListener('click', (event) => {
  if (!pokemonSearchInput.contains(event.target) && !pokemonSuggestions.contains(event.target)) {
      pokemonSuggestions.classList.remove('active');
  }
});
...
pokemonSearchInput.addEventListener('keydown', (event) => {
  const items = pokemonSuggestions.querySelectorAll('.suggestion-item');
  ...
  if (event.key === 'ArrowDown') {
      ...
      if (selectedSuggestionIndex < items.length - 1) {
          ...
          selectedSuggestionIndex = 0; // Volta para o primeiro
      }
      ...
      if (selectedSuggestionIndex > 0) {
          ...
          selectedSuggestionIndex = items.length - 1; // Volta para o último
      }
      updateSuggestionSelection(items);
  } else if (event.key === 'Enter') {
      if (selectedSuggestionIndex > -1) {
          event.preventDefault(); // Impede o envio de formulário padrão
          items[selectedSuggestionIndex].click(); // Simula o clique no item selecionado
      } else {
          // Se Enter for pressionado sem sugestão selecionada, pode-se fazer uma busca direta
          const searchTerm = pokemonSearchInput.value.trim();
          if (searchTerm) {
              alert(`Você pesquisou por: "${searchTerm}"!`);
              // Exemplo de busca real (descomente e ajuste se quiser):
              // window.open(`https://www.pokemon.com/br/pokedex/${encodeURIComponent(searchTerm)}`, '_blank');
          }
          pokemonSuggestions.classList.remove('active');
      }
  }
...
function updateSuggestionSelection(items) {
  items.forEach((item, index) => {
      if (index === selectedSuggestionIndex) {
          ...
          item.scrollIntoView({ block: 'nearest' }); // Garante que o item selecionado esteja visível
      } else {
